...
class JobValidationTests {
    ...
    void whenAllFieldsCorrectThenValidationSucceeds() {
        var job = Job.of("12345", "Developer", "Java Spring Boot Developer", "ACC", "Java", "Spring Boot");
    ...
    void whenJobIdIsNotDefinedThenValidationsFails() {
        var job = Job.of("", "Developer", "Java Spring Boot Developer", "ACC", "Java", "Spring Boot");
        Set<ConstraintViolation<Job>> violations = validator.validate(job);
